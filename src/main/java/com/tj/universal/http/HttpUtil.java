...
public class HttpUtil {
     ...
     * @throws IOException 程序异常时抛出，由调用者处理
     */
    public  static String  doPostRequest(String url, Map<String, String> headers, String jsonParams) throws IOException {
        if (null == url || url.isEmpty()) {
            throw new RuntimeException("The request URL is blank.");
        }
        ...
        connection.header("access-token","Bearer eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJhZWYzZTg4YS03MTFiLTQ2MzUtOTVkNi05MmUyNzQzOTkwYjgiLCJzdWIiOiJ6ZmNnIiwiaWF0IjoxNjE3MDk0MDA4LCJpc3MiOiJHRE1QIiwibmFtZSI6IuaUv-W6nOmHh-i0rSIsInRlbmFudElkIjoiZGVmYXVsdCIsInR5cGUiOiIxIiwicmVmcmVzaFRva2VuIjoiN2NiZTc2YTItODllNi00MjhmLTlhZDMtZTY3MjBiOWU4ZWI5In0.mSGnRBTsmu47zezUJAocTtU7eAqa92RWSZ75Ntnv628");
     ...
     * @throws IOException 程序异常时抛出，由调用者处理
     */
    public static String formPost(String url,Map<String, String> paramMap) throws IOException {
        if (null == url || url.isEmpty()) {
            throw new RuntimeException("The request URL is blank.");
        }
     ...
     * @throws IOException 程序异常时抛出，由调用者处理
     */
    public static Response doPostRequest(String url, Map<String, String> headers, Map<String, String> paramMap, Map<String, File> fileMap) throws IOException {
        if (null == url || url.isEmpty()) {
            throw new RuntimeException("The request URL is blank.");
        }
